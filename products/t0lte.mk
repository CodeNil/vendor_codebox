...
$(call inherit-product, vendor/codebox/configs/gsm.mk)

# Inherit common product files.
$(call inherit-product, vendor/codebox/configs/common.mk)

# Note 2 Overlays
PRODUCT_PACKAGE_OVERLAYS += vendor/codebox/overlay/note2-common
...
# Copy Bootanimation
PRODUCT_COPY_FILES += \
    vendor/codebox/prebuilt/xhdpi/bootanimation.zip:system/media/bootanimation.zip
